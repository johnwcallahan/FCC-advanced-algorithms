...
function makeFriendlyDates(arr) {
	...
	if (parseInt(dates[0][0]) === currentYear && isWithinYear(dates[0], dates[1])) {} else {
		friendlyDate1.push(dates[0][0]);
	}

	//push month to friendlyDate2 if needed
	if (dates[0][1] === dates[1][1] && dates[0][0] === dates[1][0]) {} else {
	...
	if (isWithinYear(dates[0], dates[1])) {} else {
